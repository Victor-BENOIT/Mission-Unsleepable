...
//Ces macros permettent d'utiliser dans le code des noms explicites (LED_GREEN, ...)
	...
	#define LEFT_BUTTON_GPIO 	GPIOA			//BOUTON POUSSOIR GAUCHE
	#define LEFT_BUTTON_PIN		GPIO_PIN_1

	#define CENTER_BUTTON_GPIO 	GPIOA			//BOUTON POUSSOIR CENTRAL
	#define CENTER_BUTTON_PIN	GPIO_PIN_2

	#define RIGHT_BUTTON_GPIO 	GPIOA			//BOUTON POUSSOIR DROIT
